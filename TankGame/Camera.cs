...
namespace TankGame
{
    public class Camera
    {
        ...
        public Camera(Vector3 targetPosition,float initialElevation,float initialRotation,float minDistance,float maxDistance,float initialDistance,float aspectRatio,float nearClip,float farClip)
        {
